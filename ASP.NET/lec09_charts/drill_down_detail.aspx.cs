...
public partial class drill_down_detail : System.Web.UI.Page
{
    /// <summary>
    /// Set up bar chart with detailed sales from category in query string
    /// </summary>
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                using (con)
                {
                    ...
                    // Set chart size
                    chtProducts.Height = 600;
                    chtProducts.Width = 600;
